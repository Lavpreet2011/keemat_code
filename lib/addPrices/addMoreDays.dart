...
class AddMoreDays extends StatefulWidget {
  ...
  @override
  _AddMoreDaysState createState() => _AddMoreDaysState();
}

class _AddMoreDaysState extends State<AddMoreDays> {
              ...
              children: <Widget>[
                ...
                CircularPercentIndicator(
                  ...
                  percent: (_cityCounter == 1)
                      ? 0
                      : ((_cityCounter) /
                          statesSwitch(widget.stateCode).length),
  ...
  _fetchDB() {
    FirebaseFirestore.instance
      ...
      _petrolData[0].list1Y.sort((a, b) => b.date.compareTo(a.date));
      _dieselData[0].list1Y.sort((a, b) => b.date.compareTo(a.date));
      _goldData[0].list1Y.sort((a, b) => b.date.compareTo(a.date));
      _silverData[0].list1Y.sort((a, b) => b.date.compareTo(a.date));
      _lpgData[0].list1Y.sort((a, b) => b.date.compareTo(a.date));
    }).then((value) {
      _addToDB();
    });
  }
